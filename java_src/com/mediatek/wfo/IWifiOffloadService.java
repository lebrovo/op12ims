            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 3:
                        ...
                        return true;
                    case TRANSACTION_getDisconnectCause /*{ENCODED_INT: 4}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        return true;
                    case TRANSACTION_setEpdgFqdn /*{ENCODED_INT: 5}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_updateCallState /*{ENCODED_INT: 6}*/:
                        data.enforceInterface(DESCRIPTOR);
                        updateCallState(data.readInt(), data.readInt(), data.readInt(), data.readInt());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_isWifiConnected /*{ENCODED_INT: 7}*/:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case TRANSACTION_updateRadioState /*{ENCODED_INT: 8}*/:
                        ...
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_setMccMncAllowList /*{ENCODED_INT: 9}*/:
                        data.enforceInterface(DESCRIPTOR);
                        boolean mccMncAllowList = setMccMncAllowList(data.createStringArray());
                        reply.writeNoException();
                        reply.writeInt(mccMncAllowList ? 1 : 0);
                        return true;
                    case TRANSACTION_getMccMncAllowList /*{ENCODED_INT: 10}*/:
                        data.enforceInterface(DESCRIPTOR);
                        String[] _result3 = getMccMncAllowList(data.readInt());
                        reply.writeNoException();
                        reply.writeStringArray(_result3);
                        return true;
                    case TRANSACTION_factoryReset /*{ENCODED_INT: 11}*/:
                        data.enforceInterface(DESCRIPTOR);
                        factoryReset();
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_setWifiOff /*{ENCODED_INT: 12}*/:
                        data.enforceInterface(DESCRIPTOR);
        ...
        public static class Proxy implements IWifiOffloadService {
            ...
            public DisconnectCause getDisconnectCause(int simIdx) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(simIdx);
                    if (!this.mRemote.transact(Stub.TRANSACTION_getDisconnectCause, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public void setEpdgFqdn(int simIdx, String fqdn, boolean wfcEnabled) throws RemoteException {
                ...
                try {
                    ...
                    if (this.mRemote.transact(Stub.TRANSACTION_setEpdgFqdn, _data, _reply, 0) || Stub.getDefaultImpl() == null) {
                        _reply.readException();
                        _reply.recycle();
                        _data.recycle();
                        return;
            ...
            public void updateCallState(int simIdx, int callId, int callType, int callState) throws RemoteException {
                ...
                try {
                    ...
                    if (this.mRemote.transact(Stub.TRANSACTION_updateCallState, _data, _reply, 0) || Stub.getDefaultImpl() == null) {
                        _reply.readException();
                        _reply.recycle();
                        _data.recycle();
                        return;
            ...
            public boolean isWifiConnected() throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(Stub.TRANSACTION_isWifiConnected, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public boolean setMccMncAllowList(String[] allowList) throws RemoteException {
                ...
                try {
                    ...
                    boolean _result = false;
                    if (!this.mRemote.transact(Stub.TRANSACTION_setMccMncAllowList, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public String[] getMccMncAllowList(int mode) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(mode);
                    if (!this.mRemote.transact(Stub.TRANSACTION_getMccMncAllowList, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public void factoryReset() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    if (this.mRemote.transact(Stub.TRANSACTION_factoryReset, _data, _reply, 0) || Stub.getDefaultImpl() == null) {
                        _reply.readException();
                        _reply.recycle();
                        _data.recycle();
                        return;
            ...
            public boolean setWifiOff() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    boolean _result = false;
                    if (!this.mRemote.transact(Stub.TRANSACTION_setWifiOff, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
