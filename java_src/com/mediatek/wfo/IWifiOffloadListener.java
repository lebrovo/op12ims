            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 3:
                        ...
                        return true;
                    case TRANSACTION_onWifiPdnOOSStateChanged /*{ENCODED_INT: 4}*/:
                        data.enforceInterface(DESCRIPTOR);
                        onWifiPdnOOSStateChanged(data.readInt(), data.readInt());
                        return true;
                    case TRANSACTION_onAllowWifiOff /*{ENCODED_INT: 5}*/:
                        data.enforceInterface(DESCRIPTOR);
                        onAllowWifiOff();
                        return true;
                    case TRANSACTION_onWfcStateChanged /*{ENCODED_INT: 6}*/:
                        data.enforceInterface(DESCRIPTOR);
        ...
        public static class Proxy implements IWifiOffloadListener {
            ...
            public void onWifiPdnOOSStateChanged(int simIdx, int oosState) throws RemoteException {
                ...
                try {
                    ...
                    if (this.mRemote.transact(Stub.TRANSACTION_onWifiPdnOOSStateChanged, _data, null, 1) || Stub.getDefaultImpl() == null) {
                        _data.recycle();
                    } else {
            ...
            public void onAllowWifiOff() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    if (this.mRemote.transact(Stub.TRANSACTION_onAllowWifiOff, _data, null, 1) || Stub.getDefaultImpl() == null) {
                        _data.recycle();
                    } else {
            ...
            public void onWfcStateChanged(int simIdx, int state) throws RemoteException {
                ...
                try {
                    ...
                    if (this.mRemote.transact(Stub.TRANSACTION_onWfcStateChanged, _data, null, 1) || Stub.getDefaultImpl() == null) {
                        _data.recycle();
                    } else {
